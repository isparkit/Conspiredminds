...
class AWB_Site_Data {
	...
	public function display_data_notice() {
		...
		$message .= sprintf( '<p>%1$s <a href="%2$s" target="_blank">%3$s</a></p>', esc_html__( 'Become a contribution hero by opting in to share some non-sensitive usage data with us, that will help us to improve the product.', 'Avada' ), esc_url( 'https://avada.com/documentation/user-website-data-collection/' ), esc_html__( 'Learn more.', 'Avada' ) );
