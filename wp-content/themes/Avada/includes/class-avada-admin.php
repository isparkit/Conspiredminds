...
class Avada_Admin {
	...
	public function __construct() {
		...
		if ( isset( $data_status['status'] ) && 'dismissed' != $data_status['status'] ) { // phpcs:ignore WordPress.Security.NonceVerification.Missing, WordPress.Security.NonceVerification.Recommended
					...
					<div class="avada-db-footer-top">
						<nav class="avada-db-footer-menu">
							...
							<ul>
								...
								<li>
									<a href="https://theme-fusion.com/support/submit-a-ticket/" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Submit A Ticket', 'Avada' ); ?></a>
								</li>
							</ul>
						</nav>
