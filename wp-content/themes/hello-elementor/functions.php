...
// add_action( 'conspiredminds', 'cw_function' );
...
function author_fields( $user ) { ?>
    <table class="form-table">
        <tr>
            <th><label for="bin_number">User BIN Number:</label></th>
            <td>
                <input type="text" name="bin_number" id="bin_number" class="regular-text" value="<?php esc_attr( get_the_author_meta( 'bin_number', $user->ID ) ); ?>" />
                <br />
                <span class="description">Please enter your Bin Number</span>
            </td>
        </tr>
    </table>
<?php }

add_action( 'show_user_profile', 'author_fields' );
add_action( 'edit_user_profile', 'author_fields' );
...
function save_author_fields( $user_id ) {
    ...
    update_user_meta( $user_id, 'bin_number', $_POST['bin_number'] );
}
